...
do when a snippet does not fire. The specification the implementation is held to
is `Instructions.md` §31; the file format's schema is
`src/renderer/snippets/eusnips/schema.json`.
